...
`cao(group: <function group at 0x7fce30cf4550>, cmd: str) ‑> List[Callable[[Callable[[Any], Any]], Callable[[Any], Any]]]`
...
`command(group: <function group at 0x7fce30cf4550>) ‑> Callable[[Callable[[Any], Any]], Callable[[Any], Any]]`
