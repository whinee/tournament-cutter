...
`cao(group: <function group at 0x7f1f5faf4310>, cmd: str) ‑> List[Callable[[Callable[[Any], Any]], Callable[[Any], Any]]]`
...
`command(group: <function group at 0x7f1f5faf4310>) ‑> Callable[[Callable[[Any], Any]], Callable[[Any], Any]]`
