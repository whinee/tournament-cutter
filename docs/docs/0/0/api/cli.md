...
`cao(group: <function group at 0x7f6e714f0310>, cmd: str) ‑> List[Callable[[Callable[[Any], Any]], Callable[[Any], Any]]]`
...
`command(group: <function group at 0x7f6e714f0310>) ‑> Callable[[Callable[[Any], Any]], Callable[[Any], Any]]`
