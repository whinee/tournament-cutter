...
`cao(group: <function group at 0x7fd63a500550>, cmd: str) ‑> List[Callable[[Callable[[Any], Any]], Callable[[Any], Any]]]`
...
`command(group: <function group at 0x7fd63a500550>) ‑> Callable[[Callable[[Any], Any]], Callable[[Any], Any]]`
